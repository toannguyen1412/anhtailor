export function useFeedbacks() {
  ...
  const feedbackImages: Array<{ src: string; altKey: string; index: number }> =
    [
      // customer (1) - (23)
      ...
      // customer-01
      {
        src: "/images/feedback/customer-01/image (1).jpg",
        altKey: "customerPhoto",
        index: 24,
      },
      {
        src: "/images/feedback/customer-01/image (2).jpg",
        altKey: "customerPhoto",
        index: 25,
      },
      // customer-andilya
      {
        src: "/images/feedback/customer-andilya/image (1).jpg",
        altKey: "customerPhoto",
        index: 26,
      },
      {
        src: "/images/feedback/customer-andilya/image (1).png",
        altKey: "customerPhoto",
        index: 27,
      },
      {
        src: "/images/feedback/customer-andilya/image (2).jpg",
        altKey: "customerPhoto",
        index: 28,
      },
      {
        src: "/images/feedback/customer-andilya/image (3).jpg",
        altKey: "customerPhoto",
        index: 29,
      },
      // customer-clanhlan
      {
        src: "/images/feedback/customer-clanhlan/image.png",
        altKey: "customerPhoto",
        index: 30,
      },
      // customer-graham-davis
      {
        src: "/images/feedback/customer-graham-davis/image.jpg",
        altKey: "customerPhoto",
        index: 31,
      },
      // customer-lorenzo tasca
      {
        src: "/images/feedback/customer-lorenzo tasca/image (1).jpg",
        altKey: "customerPhoto",
        index: 32,
      },
      {
        src: "/images/feedback/customer-lorenzo tasca/image (1).png",
        altKey: "customerPhoto",
        index: 33,
      },
      {
        src: "/images/feedback/customer-lorenzo tasca/image (2).jpg",
        altKey: "customerPhoto",
        index: 34,
      },
      {
        src: "/images/feedback/customer-lorenzo tasca/image (2).png",
        altKey: "customerPhoto",
        index: 35,
      },
      // customer-malin gumabon
      {
        src: "/images/feedback/customer-malin gumabon/image (1).jpg",
        altKey: "customerPhoto",
        index: 36,
      },
      {
        src: "/images/feedback/customer-malin gumabon/image (2).jpg",
        altKey: "customerPhoto",
        index: 37,
      },
      {
        src: "/images/feedback/customer-malin gumabon/image (3).jpg",
        altKey: "customerPhoto",
        index: 38,
      },
    ];
  ...
  const feedbackImagesWithTranslations = computed(() => {
    return feedbackImages.map((image) => ({
      ...image,
      alt:
        t("viewCustomerPhoto").replace("{index}", image.index.toString()) +
        " - Anh Tailor",
    }));
  });
  ...
  const textFeedbacks = [
    ...
    },
    {
      name: "Lê Minh Đức",
      content:
        "Giá cả hợp lý, thời gian may nhanh chóng! Chỉ 2-3 ngày là có áo veston. Chất lượng tốt, giá rẻ hơn nhiều nơi khác. Rất hài lòng!",
      country: "Vietnam",
      rating: 5,
    },
    {
  ...
  const formatTimeAgo = (date: Date) => {
    ...
    if (diffYears > 0) {
      ...
      return `${diffYears} ${diffYears > 1 ? timeAgo.years : timeAgo.year} ${
        timeAgo.ago
      }`;
      ...
      if (diffDays >= 7) {
        ...
        return `${weeks} ${weeks > 1 ? timeAgo.weeks : timeAgo.week} ${
          timeAgo.ago
        }`;
      }
      return `${diffDays} ${diffDays > 1 ? timeAgo.days : timeAgo.day} ${
        timeAgo.ago
      }`;
    } else if (diffHours > 0) {
      return `${diffHours} ${diffHours > 1 ? timeAgo.hours : timeAgo.hour} ${
        timeAgo.ago
      }`;
    } else if (diffMinutes > 0) {
      return `${diffMinutes} ${
        diffMinutes > 1 ? timeAgo.minutes : timeAgo.minute
      } ${timeAgo.ago}`;
    } else {
